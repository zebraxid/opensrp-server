...
public class AlertHandler {
    ...
    private Matcher motherSchedules() {
        return anyOf(SCHEDULE_ANC, SCHEDULE_TT_1, SCHEDULE_TT_2, SCHEDULE_IFA_1, SCHEDULE_IFA_2, SCHEDULE_IFA_3,
                ...
                SCHEDULE_DELIVERY_PLAN, SCHEDULE_TT_INA_1, SCHEDULE_TT_INA_2, SCHEDULE_INA_HB_1,SCHEDULE_INA_HB_FOLLOW,SCHEDULE_INA_HB_2,
    ...
    private Matcher ecSchedules() {
        return anyOf(EC_SCHEDULE_DMPA_INJECTABLE_REFILL,
                ...
                SCHEDULE_KB_IMPLANT,
                SCHEDULE_KB_INJECT_DEPOPROVERA,
                SCHEDULE_KB_INJECT_CYCLOFEM,
                SCHEDULE_KB_IUD);
    }
}
