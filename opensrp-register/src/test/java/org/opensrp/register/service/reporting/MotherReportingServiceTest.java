...
/*
    ...
    public void shouldReportANC4ProvidedWhenANCVisitIsAfter36WeeksAndAlready3ANCVisitsHappened() {
        ...
        Map<String, String> ancVisit1 = create("ancDate", "2012-03-04")
                .put("ancKe", "1")
                .map();
        Map<String, String> ancVisit2 = create("ancDate", "2012-05-04")
                .put("ancKe", "2")
                .map();
        Map<String, String> ancVisit3 = create("ancDate", "2012-07-04")
                .put("ancKe", "3")
                .map();
        Map<String, String> ancVisit4 = create("ancDate", visitDate)
                .put("ancKe", "4")
                .map();
        ...
        SafeMap reportData = new SafeMap();
        reportData.put("id", "CASE-1");
        reportData.put("ancDate", visitDate);
...
*/
    ...
    private ReportingData serviceProvided(Indicator indicator, String date, String dristhiEntityId) {
        return serviceProvidedData("ANM X", "TC 1", indicator, date, new Location("bherya", "bherya", "bherya"), dristhiEntityId);
    }
