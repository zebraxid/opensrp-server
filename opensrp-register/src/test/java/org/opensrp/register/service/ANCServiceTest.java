...
public class ANCServiceTest {
    ...
    public void setUp() throws Exception {
        initMocks(this);
        service = new ANCService(allMothers, eligibleCouples, ancSchedulesService, motherReportingService, reportFieldsDefinition);
    }
    ...
    public void shouldRegisterANC() {
        ...
        FormSubmission submission = create()
                ...
                .addFormField("tanggalHPHT", lmp.toString())
