...
public class PNCServiceTest extends BaseUnitTest {
    ...
    public void setUp() throws Exception {
        initMocks(this);
        service = new PNCService(pncSchedulesService, allEligibleCouples, allMothers, children,
    ...
    public void shouldAutoClosePNCCaseWhenMotherExists() {
        ...
        verify(pncSchedulesService).fulfillPNCAutoCloseMilestone("MOTHER-CASE-1", "ANM 1");
        verify(pncSchedulesService).generateMotherClosedAlert("MOTHER-CASE-1", "ANM 1");
        verifyZeroInteractions(motherReportingService);
    }
