...
public class RegisterController {
	...
	public ResponseEntity<List<CountServiceDTO>> getHouseHoldInformation(@RequestParam("anm-id") String provider,
			@RequestParam("start-month") String startMonth, @RequestParam("end-month") String endMonth, @RequestParam("start-week") String startWeek,
			@RequestParam("end-week") String endtWeek, @RequestParam("type") String type) {
	...
	@ResponseBody
	public ResponseEntity<List<CountServiceDTOForChart>> getHouseHoldInformationForChart(@RequestParam("provider") String provider,
			@RequestParam("district") String district, @RequestParam("upazilla") String upazilla, @RequestParam("union") String union) {
	...
	@ResponseBody
	public ResponseEntity<List<CountServiceDTOForChart>> getElcoInformationForChart(@RequestParam("provider") String provider,
			@RequestParam("district") String district, @RequestParam("upazilla") String upazilla, @RequestParam("union") String union) {
	...
	@ResponseBody
	public ResponseEntity<List<CountServiceDTOForChart>> getPWInformationForChart(@RequestParam("provider") String provider,
			@RequestParam("district") String district, @RequestParam("upazilla") String upazilla, @RequestParam("union") String union) {
