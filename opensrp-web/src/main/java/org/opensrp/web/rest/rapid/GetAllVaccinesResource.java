...
import static org.opensrp.common.AllConstants.Event.VACCINE_SEARCH_INDENTIFIER;
...
public class GetAllVaccinesResource {
	...
	protected ResponseEntity<String> sync(HttpServletRequest request) {
		...
		try {
			...
			JsonArray vaccinesArray = (JsonArray) gson.toJsonTree(vaccines(eventsMap), new TypeToken<List<Vaccines>>() {}.getType());
	...
	public static List<Vaccines> vaccines(Map<String, Object> events) {
		...
		Vaccines vaccineObjects = new Vaccines();
		try {
