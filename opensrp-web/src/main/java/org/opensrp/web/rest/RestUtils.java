...
public class RestUtils {
	...
	public static enum CONCEPTS {
		...
		WEIGHT("5089AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), PALLOR("5245AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), SWELLING("130428AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), BATHCANALBLEEDING("147232AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
		JAUNDICE("136443AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), CONVULSIONS("206AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),BNFSTATUS("161641AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), LIVEBIRTH("151849AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
		STILLBIRTH("125872AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), MISCARRIAGE("125872AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),ABORTION("50AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),CHILDNAME("1586AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
		CHILDGENDER("1587AAAAAAAAAAAAAAAAAAAAAAAAAAAA"), MALEGENDER("1534AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), FEMALEGENDER("1535AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),UNKNOWN("1067AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
		OTHERGENDER("5622AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), DATEOFCONFINEMENT("5599AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),YES("1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),NO("1066AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
		ANCDATE("160753AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
		;
		...
		static {
			// Create reverse lookup hash map
			for (CONCEPTS d : CONCEPTS.values())
				lookup.put(d.toString(), d.getConceptValue());
		}
	...
	public enum ANCMILESTONE {
		ANC1("ancrv_1"), ANC2("ancrv_2"), ANC3("ancrv_3"), ANC4("ancrv_4");

	    private String value;

	    private ANCMILESTONE(String value) {
	        this.value = value;
	    }
