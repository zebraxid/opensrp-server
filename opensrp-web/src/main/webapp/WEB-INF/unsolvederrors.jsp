	...
	<div class="row">
		<div class="col-md-3">
			<ul class="nav nav-stacked nav-tabs">
				<li >
					<a href="/errorhandler/errortrace?id=0" >All Errors</a>
				</li>
				<li >
					<a href="/errorhandler/solvederrors?id=2" >Solved Errors</a>
				</li>
				<li class="active" >
					<a href="/errorhandler/unsolvederrors?id=1">Unsolved Errors</a>
				</li>
