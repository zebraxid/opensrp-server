...
public class OpenmrsLocationService extends OpenmrsService {
	...
	private Location makeLocation(String locationJson) throws JSONException {
		...
		org.opensrp.api.domain.Address address = new org.opensrp.api.domain.Address(null, null, null, addressFields, null,
		        null, null, null, null);
		
		Location l = new Location(obj.getString("uuid"), obj.getString("name"), address, null, p, null, null);
