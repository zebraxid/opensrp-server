...
public class FormEventListenerTest {
    ...
    public void shouldDelegateFormSubmissionToSubmissionService() throws Exception {
        List<FormSubmissionDTO> formSubmissions = asList(new FormSubmissionDTO("anm id 1", "getFormInstance id 1", "entity id 1", "form name", null, "0", "1"),
                new FormSubmissionDTO("anm id 2", "getFormInstance id 2", "entity id 2", "form name", null, "0", "1"));
    ...
    public void shouldFetchFormSubmissionsFromSubmissionService() throws Exception {
    	FormSubmission fs1 = new FormSubmission("anm id 1", "getFormInstance id 1", "form name", "entity id 1", "1.0", 0L, new FormInstance(new FormData("test","def/bindpath", new ArrayList<FormField>(), null))),
        fs2 = new FormSubmission("anm id 2", "getFormInstance id 2", "form name", "entity id 2", "1.0", 0L, new FormInstance(new FormData("test","def/bindpath", new ArrayList<FormField>(), null)));
