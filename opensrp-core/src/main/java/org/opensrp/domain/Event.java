...
public class Event extends BaseDataObject {
	...
	public Obs getObs(String parent, String concept) {
		...
		for (Obs o : obs) {
			...
			if ((StringUtils.isBlank(parent) || (StringUtils.isNotBlank(o.getParentCode()) && parent.equalsIgnoreCase(o
			        .getParentCode()))) && o.getFieldCode().equalsIgnoreCase(concept)) {
	...
	public Event withIsSendToOpenMRS(String isSendToOpenMRS) {
