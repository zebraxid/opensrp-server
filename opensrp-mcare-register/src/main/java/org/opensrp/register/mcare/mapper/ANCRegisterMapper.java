                        ...
                        .convert(new Converter<ANCRegisterEntry, ANC_RegisterEntryDTO>() {
                            ...
                            public ANC_RegisterEntryDTO convert(ANCRegisterEntry entry) {
                                return new ANC_RegisterEntryDTO()
	                            	...
	                            	.withanc1_current_formStatus(entry.anc1_current_formStatus())
	                            	.withANC2_current_formStatus(entry.ANC2_current_formStatus())
	                            	.withANC3_current_formStatus(entry.ANC3_current_formStatus())
	                            	.withANC4_current_formStatus(entry.ANC4_current_formStatus())
