                ...
                with(elcoRegister.ecRegisterEntries())
                        .convert(new Converter<ELCORegisterEntry, ELCORegisterEntryDTO>() {
                            ...
                            public ELCORegisterEntryDTO convert(ELCORegisterEntry entry) {
                        		...
                        		.withexisting_ELCO(entry.existing_ELCO())
			            		.withnew_ELCO(entry.new_ELCO())
			            		.withELCO(entry.ELCO())
			            		.withWomanREGDATE(entry.WomanREGDATE())
			            		.withFWNHWOMHUSALV(entry.FWNHWOMHUSALV())
			            		.withFWNHWOMHUSLIV(entry.FWNHWOMHUSLIV())
			            		.withFWNHWOMHUSSTR(entry.FWNHWOMHUSSTR())
			            		.withFWNHWOMSTRMEN(entry.FWNHWOMSTRMEN())
