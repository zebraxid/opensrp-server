...
@Component
public class AdolescentHealthHandler implements FormSubmissionHandler {

	private MembersPaybackService womanService;

	@Autowired
	public AdolescentHealthHandler(MembersPaybackService womanService) {
		this.womanService = womanService;
	}
	
	@Override
	public void handle(FormSubmission submission) {
		womanService.AdolescentHealthHandler(submission);	
	}
