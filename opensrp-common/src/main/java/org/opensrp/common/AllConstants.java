...
public class AllConstants {
	...
	public static final String OPENSRP_Form_DATABASE_LUCENE_CONNECTOR = "opensrpFormDatabaseLuceneConnector";
	...
	public static class Form {
		...
		public static final String NOTPROCESSING = "9001";
	...
	public static class ELCORegistrationFields {
		...
		public static final String FWPSRPREGSTS = "FWPSRPREGSTS";
	...
	public static class PSRFFields {
		...
		public static final String FW_PSRPREGWTD = "FWPSRPREGWTD";
	...
	public static class VitaminAFields {
		...
		public static final List<String> VITAMIN_A_DOSES_1_2_5_9 = asList(VITAMIN_A_DOSE_1_VALUE, VITAMIN_A_DOSE_2_VALUE,
		    VITAMIN_A_DOSE_5_VALUE, VITAMIN_A_DOSE_9_VALUE);
	...
	public static class ScheduleNames {
		...
		public static final String PNCRV = "pncrv";
