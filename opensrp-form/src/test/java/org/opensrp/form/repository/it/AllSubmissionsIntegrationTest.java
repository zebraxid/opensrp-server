...
public class AllSubmissionsIntegrationTest {
    ...
    public void shouldCheckIfFormSubmissionExistsByInstanceId() throws Exception {
        FormSubmission formSubmission = new FormSubmission("anm id 1", "instance id 1", "form name 1", "entity id 1", null, 1L, "1", null, 0L);
    ...
    public void shouldFetchAllFormSubmissionsAfterServerVersion() throws Exception {
        ...
        FormSubmission firstFormSubmission = new FormSubmission("anm id 1", "instance id 1", "form name 1", "entity id 1", null, 0L, "1", null, baseTimeStamp);
        formSubmissions.add(firstFormSubmission);

        FormSubmission secondFormSubmission = new FormSubmission("anm id 2", "instance id 2", "form name 1", "entity id 2", null, 1L, "1", null, baseTimeStamp + 1);
        formSubmissions.add(secondFormSubmission);

        FormSubmission thirdFormSubmission = new FormSubmission("anm id 3", "instance id 3", "form name 1", "entity id 3", null, 2L, "1", null, baseTimeStamp + 2);
    ...
    public void shouldFetchFormSubmissionsBasedOnANMIDTimeStampAndBatchSize() throws Exception {
        long baseTimeStamp = DateUtil.now().getMillis();
        FormSubmission firstFormSubmission = new FormSubmission("ANM 1", "instance id 1", "form name 1", "entity id 1", null, 0L, "1", null, baseTimeStamp);
        formSubmissions.add(firstFormSubmission);

        FormSubmission secondFormSubmission = new FormSubmission("ANM 1", "instance id 2", "form name 1", "entity id 2", null, 1L, "1", null, baseTimeStamp + 1);
        formSubmissions.add(secondFormSubmission);

        FormSubmission thirdFormSubmission = new FormSubmission("ANM 1", "instance id 3", "form name 1", "entity id 3", null, 2L, "1", null, baseTimeStamp + 2);
        formSubmissions.add(thirdFormSubmission);
