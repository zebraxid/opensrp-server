...
public class FormSubmissionServiceTest {
    ...
    public void shouldSortAllSubmissionsAndSaveEachOne() throws Exception {
        ...
        FormSubmissionDTO earlierFormSubmissionDTO = new FormSubmissionDTO("anm id 1", "instance id 1", "entity id 1", "form name 1", "loc_id 1", null, valueOf(baseTimeStamp), "1");
        FormSubmissionDTO laterFormSubmissionDTO = new FormSubmissionDTO("anm id 2", "instance id 2", "entity id 2", "form name 1", "loc_id 2", null, valueOf(baseTimeStamp + 1), "1");
        FormSubmissionDTO veryLateFormSubmissionDTO = new FormSubmissionDTO("anm id 2", "instance id 3", "entity id 3", "form name 1", "loc_id 3", null, valueOf(baseTimeStamp + 2), "1");
        FormSubmission earlierFormSubmission = new FormSubmission("anm id 1", "instance id 1", "form name 1", "loc_id 1", "entity id 1", baseTimeStamp, "1", null, serverVersion);
        FormSubmission laterFormSubmission = new FormSubmission("anm id 2", "instance id 2", "form name 1", "loc_id 2", "entity id 2", baseTimeStamp + 1, "1", null, serverVersion);
        FormSubmission veryLateFormSubmission = new FormSubmission("anm id 2", "instance id 3", "form name 1", "loc_id 3", "entity id 3", baseTimeStamp + 2, "1", null, serverVersion);
    ...
    public void shouldNotDelegateFormSubmissionIfAlreadyExists() throws Exception {
        long baseTimeStamp = DateUtil.now().getMillis();
        FormSubmissionDTO firstFormSubmissionDTO = new FormSubmissionDTO("anm id 1", "instance id 1", "entity id 1", "form name 1", "loc_id 1", null, valueOf(baseTimeStamp), "1");
        FormSubmissionDTO secondFormSubmissionDTO = new FormSubmissionDTO("anm id 2", "instance id 2", "entity id 2", "form name 1", "loc_id 2", null, valueOf(baseTimeStamp + 1), "1");
        FormSubmission firstFormSubmission = new FormSubmission("anm id 1", "instance id 1", "form name 1", "loc_id 1", "entity id 1", baseTimeStamp, "1", null, serverVersion);
        FormSubmission secondFormSubmission = new FormSubmission("anm id 2", "instance id 2", "form name 1", "loc_id 2", "entity id 2", baseTimeStamp + 1, "1", null, serverVersion);
    ...
    public void shouldFetchFormSubmissionsByGiven() throws Exception {
        long baseTimeStamp = DateUtil.now().getMillis();
        FormSubmissionDTO firstFormSubmissionDTO = new FormSubmissionDTO("anm id 1", "instance id 1", "entity id 1", "form name 1", "loc_id 1", "", valueOf(baseTimeStamp), "1").withServerVersion("0");
        FormSubmissionDTO secondFormSubmissionDTO = new FormSubmissionDTO("anm id 2", "instance id 2", "entity id 2", "form name 1", "loc_id 2", "", valueOf(baseTimeStamp + 1), "1").withServerVersion("1");
        FormSubmission firstFormSubmission = new FormSubmission("anm id 1", "instance id 1", "form name 1", "loc_id 1", "entity id 1", baseTimeStamp, "1", null, 0L);
        FormSubmission secondFormSubmission = new FormSubmission("anm id 2", "instance id 2", "form name 1", "loc_id 2", "entity id 2", baseTimeStamp + 1, "1", null, 1L);
