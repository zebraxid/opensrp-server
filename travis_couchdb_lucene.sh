...
sudo sed -i -e '$a fti=/usr/bin/python /home/travis/build/OpenSRP/opensrp-server/couchdb-lucene-1.1.0/target/couchdb-lucene-1.1.0/tools/couchdb-external-hook.py' $couchdb_local_ini_location
